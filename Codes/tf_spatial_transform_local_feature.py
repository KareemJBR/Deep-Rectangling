...
def transformer(_u, theta, name='SpatialTransformer'):
    ...
    def _transform3(_theta, input_dim):
        with tf.variable_scope('_transform'):
            ...
            hs = get_Hs(_theta, width_float, height_float)
    ...
    with tf.variable_scope(name):
        ...
        # U = U - 1.
        warp_image = _transform3(theta, _u)
