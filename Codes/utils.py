...
def get_cropped(input_filename, gt_filename, mask_filename, top_left, bottom_right):
    input_image = np_load_frame(filename=input_filename, resize_height=384, resize_width=512)
